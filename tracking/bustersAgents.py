...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        GhostPosition=[]
        #find the most possible position of each ghost
        for belief in livingGhostPositionDistributions:
            maxBeliefPos=belief.argMax()
            GhostPosition.append(maxBeliefPos)
        ...
        for pos in GhostPosition:
            ...
            if  dis<bestDis:
                bestDis=dis
                bestPos=pos
        #get action towards the target ghost
        for action in legal:
            if self.distancer.getDistance(bestPos, Actions.getSuccessor(pacmanPosition, action))<bestDis:
                bestAction=action
